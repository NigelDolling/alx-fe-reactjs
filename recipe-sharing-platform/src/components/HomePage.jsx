    ...
    <main className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 md:gap-8">
        {recipes.map((recipe) => (
          <article
            key={recipe.id}
            className="bg-white dark:bg-neutral-800 rounded-xl shadow hover:shadow-xl transition-transform duration-200 ease-out transform hover:-translate-y-0.5 overflow-hidden border border-gray-100 dark:border-neutral-700"
          >
